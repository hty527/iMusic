...
public class MusicOrientationListener implements SensorEventListener {

    private static final String TAG = "MusicOrientationListener";
    //设备旋转的角度，依次顺时针角度
    private int mOrientation = 0;
    private OnOrientationChangeListener mListener;

    public MusicOrientationListener(OnOrientationChangeListener listener){
