package com.music.player.lib.view.blur.widget;
...
import com.music.player.lib.view.blur.impl.AndroidStockBlurImpl;
import com.music.player.lib.view.blur.impl.AndroidXBlurImpl;
import com.music.player.lib.view.blur.impl.BlurImpl;
import com.music.player.lib.view.blur.impl.EmptyBlurImpl;
import com.music.player.lib.view.blur.impl.SupportLibraryBlurImpl;

/**
 * created by hty
 * 2022/6/19
 * Desc:实时虚化背景
 * 原著地址：implementation 'com.github.mmin18:realtimeblurview:1.2.1'
 */
public class RuntimeBlurView extends View {
    ...
    public RuntimeBlurView(Context context) {
        this(context,null);
    }

    public RuntimeBlurView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RuntimeBlurView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mBlurImpl = getBlurImpl(); // provide your own by override getBlurImpl()

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RuntimeBlurView);
        mBlurRadius = a.getDimension(R.styleable.RuntimeBlurView_realtimeBlurRadius,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, context.getResources().getDisplayMetrics()));
        mDownsampleFactor = a.getFloat(R.styleable.RuntimeBlurView_realtimeDownsampleFactor, 4);
        mOverlayColor = a.getColor(R.styleable.RuntimeBlurView_realtimeOverlayColor, 0xAAFFFFFF);
        a.recycle();
