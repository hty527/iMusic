...
### 重要通知：
本开源项目建立之初衷：纯属技术爱好，也是对相关知识点进行一个技术总结以及方便自己甚至开发同行快速实现音频播放、视频播放及交互等功能。
...
现出于对此种行为抵制，本人现将工程中示例模块代码删除！另外两个依赖库music和video库不受影响，照常版本更新和维护。
如果您有意向项目合作或者您是个人开发者需要示例模块的相关代码，请联系下方邮箱索要完整源码。对此带来的不便，敬请谅解！2019-08-09
