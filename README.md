...
### 重要通知：本开源项目建立之初衷为：纯属技术爱好，也是对相关知识点进行一个技术总结以及方便自己甚至开发同行少走弯路简易快速实现功能而生。
但近期通过统计后台发现有不良网站或组织或个人将此项目示例工程download后更改包名(com.kuaikanyingshi.kkys)，修改示例工程源码（还TM的改出BUG来了）后直接面向互联网用户分发。
每天有几十甚至几百上千人的用户增长。对于此种恶劣行径我在此表示强烈谴责和愤慨！坚决抵制此等不良互联网精神。
现出于对此种行为抵制，本人现将工程中示例模块代码删除！另外两个依赖库music和video库不受影响，照常版本更新和维护。如果您是个人开发者需要示例模块的相关代码，请联系下方邮箱索要完整源码。对此带来的不便，敬请谅解！2019-08-09
### 免责声明：
此项目中应用到了酷狗API、开眼API，纯属Demo演示，无任何商业用途，禁止任何人将示例项目中的第三方API应用于商业用途，如果使用了，连带的法律责任与本作者无关!
...
```
    dependencies {
        implementation 'com.imusic.player:video-player:1.0.71'
    }
```
**2.xml中引入播放器通道布局</br>**
```
...
[点击下载Apk]: https://raw.githubusercontent.com/Yuye584312311/ConfigFile/master/apk/iMusic-1.1.71.apk "apk下载"
**本地下载：** **[点击下载Apk]**<br/>
<br/>
**或者扫描二维码下载<br/>**
<div align="center">
