...
public class MusicRoundImageView extends AppCompatImageView {
    ...
    public MusicRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public MusicRoundImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        matrix = new Matrix();
        bitmapPaint = new Paint();
        bitmapPaint.setAntiAlias(true);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.MusicRoundImageView);
        type = array.getInt(R.styleable.MusicRoundImageView_image_type, TYPE_CIRCLE);
        scaleType = array.getInt(R.styleable.MusicRoundImageView_image_scale, SCALE_TYPE_FIT);

        corners_top_left = array.getBoolean(R.styleable.MusicRoundImageView_image_top_left, true);
        corners_top_right = array.getBoolean(R.styleable.MusicRoundImageView_image_top_right, true);
        corners_bottom_left = array.getBoolean(R.styleable.MusicRoundImageView_image_bottom_left, true);
        corners_bottom_right = array.getBoolean(R.styleable.MusicRoundImageView_image_bottom_right, true);
        borderRadius = array.getDimensionPixelSize(R.styleable.MusicRoundImageView_image_borderRadius,
